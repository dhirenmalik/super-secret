...
export default function AgentInsights({
    ...
    const filteredAnomalies = useMemo(() => {
        ...
        return anomaliesTable.filter(row => {
            ...
            const rowType = row.SourceFile || row.Anomaly_Type || '';
            const matchType = !typeFilter || typeFilter === 'All' || rowType === typeFilter;
            return matchTactic && matchSeverity && matchType;
        });
    }, [anomaliesTable, tacticFilter, severityFilter, typeFilter]);
